...
public enum ResultCode {
    ...
    CAPTCHA_ERROR(10000, "图形验证码错误"),
    NO_DATA(10001, "无数据"),
    NOT_VIP(10002, "您还不是高级会员，开通高级会员后将自动解锁该功能"),
    UPLOAD_FAIL(10003, "上传失败"),
    //签名校验失败
    SIGNATURE_ERROR(10004, "签名错误"),
    //验证码发送频繁
    CAPTCHA_SEND_TOO_MANY_TIMES(10005, "验证码发送次数过多"),
    USERNAME_OR_PASSWORD_ERROR(1000, "用户名或密码错误"),
    DUPLICATE_KEY(10009, "数据已存在"),
