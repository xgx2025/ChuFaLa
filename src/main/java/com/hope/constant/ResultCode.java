...
public enum ResultCode {
    ...
    EMAIL_ALREADY_EXISTS(2001, "邮箱已存在"),
    EMAIL_NOT_FOUND(2002, "邮箱不存在"),
    EMAIL_NOT_VERIFIED(2003, "邮箱未验证"),
    EMAIL_VERIFY_CODE_ERROR(2004, "邮箱验证码错误"),
    EMAIL_VERIFY_CODE_EXPIRED(2005, "邮箱验证码已过期"),
    ...
    EMAIL_VERIFY_CODE_SEND_TOO_MANY_TIMES_TODAY(2009, "邮箱验证码发送次数过多"),
    EMAIL_VERIFY_CODE_SEND_TOO_MANY_TIMES_TODAY_TODAY(2010, "邮箱验证码发送次数过多"),
